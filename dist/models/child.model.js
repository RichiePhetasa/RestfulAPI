...
class child {
    constructor(norm) {
        this.model = [{
                ...
                insurance: { type: String, maxlength: 24 },
                medical_condition: { type: String, maxlength: 1000 },
                dietary_information: { type: String, maxlength: 1000 },
                image_url: { type: String, maxlength: 1000 },
                afaf: { type: String, maxlength: 1000 },
                user_id: {
                    type: Number,
                    key: 'foreign',
